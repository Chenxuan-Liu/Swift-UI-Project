...
//public struct MyAnimationModifer: AnimatableModifier {
...
//        GridView(store: self.store, fraction: fractionComplete)
//    }
//    public init() {
...
//        self.fractionComplete = fraction
    }
...
//            .rotationEffect(
//                Angle(radians: -Double.pi * 4.0 * fractionComplete)
//            )
